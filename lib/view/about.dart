        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              20.h,
              Text(controller.aboutUs['about_title'], style: bolder(fontSize: 20, color: CustomColors().primaryColorDark)),
              10.h,
              Text(controller.aboutUs['address'], style: bolder(fontSize: 14, color: CustomColors().grey500)),
              10.h,
              Column(
                ...
                children: [
                  ...
                  20.h,
                  Center(
                    child: Text('© 2026 All Rights Reserved & Managed by', style: bolder(fontSize: 16, color: CustomColors().grey500)),
                  ),
                  Center(
                    child: Text('Shree Guru Ashram - Bagdana', style: bolder(fontSize: 16, color: CustomColors().black)),
                  ),
                  Center(
                    child: RichText(
                      text: TextSpan(
