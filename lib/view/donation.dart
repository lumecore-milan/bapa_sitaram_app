...
String getInitialItem(){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:widget.showAppBar==false ? null: CustomAppbar(title: 'ડોનેશન', showDrawerIcon: false, onBackTap: (){
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                10.h,
                Text(
                  'નોંધ : દાનની રસીદ મેળવવા માટે કૃપા કરી નીચેની પ્રક્રિયા અનુસરો . કર કપાતપાત્ર યોગદાન માટે ચુકવણી રસીદો  માટે માન્ય સંપર્ક માહિતી જરૂર પડશે.',
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          InkWell(
                            ...
                            child: Obx(
                                ...
                                decoration: BoxDecoration(
                                  color: _controller.isPrivacyAccepted.value == true
                                ...
                                child: _controller.isPrivacyAccepted.value == true
                                    ? Icon(
                                  Icons.check,
                          ...
                          10.w,
                          Text(
                            'મેં નિયમો અને શરતો વાંચી છે અને આથી તે સાથે સંમત છુ.',
                            style: semiBold(fontSize: 12,color: CustomColors().grey600),
                          ),
                        ],
                      ),
                      20.h,
