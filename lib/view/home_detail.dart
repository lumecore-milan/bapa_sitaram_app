            ...
            InkWell(
              onTap: () {
                if (_controller.homeDetail.value.liveArti.isNotEmpty && Uri.tryParse(_controller.homeDetail.value.liveArti) != null) {
                  navigate(context: context, replace: false, path: _controller.homeDetail.value.liveArti.startsWith('https://www.youtube.com') ? youtubeVideoRoute : youtubeVideoRoute, param: _controller.homeDetail.value.liveArti);
                }
              },
