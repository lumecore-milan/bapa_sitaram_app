...
class HelperService {
  ...
  Future<String?> pickFile(
      {int defaultFileSizeINKB = 4096,
        ...
        required AllowedFileType fileType}) async {
    try {
      ...
      final FilePickerResult? selectedFile = await FilePicker.platform
          .pickFiles(
          allowMultiple: false,
      ...
      if (selectedFile != null) {
        ...
        if (extension.toUpperCase() == 'HEIC' ||
            extension.toUpperCase() == 'HEIF' ||
            extension.toUpperCase() == 'HEICS') {
  ...
  Future<String> getDownloadDirectory() async {
    ...
    try {
      ...
      LoggerService().log(
        message: 'Error while getting download directory===>$ex',
      );
    }
    return '';
  }
